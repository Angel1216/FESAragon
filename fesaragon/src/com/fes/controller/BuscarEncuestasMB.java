...
import com.fes.DAO.BuscarEncuestasDAO;

@ManagedBean(name="buscarEncuestasMB")
@ViewScoped
public class BuscarEncuestasMB extends BuscarEncuestasDAO implements Serializable{
